...
#take output from retinanet model ()
#feed bounding box images to the retinanet model
#take identified images from retinanet output model into here 
#how to do we keep bounding boxes on all images from same camera?

class TrafficFlow:
    def __init__(self):
        self.shapes = {}

    def import_shapes(self, shapes_dir): #json directory
        """
    ...
    def filter_by_iou(self, bbox, collisions): #don't worry about this, just choose bottom center
        """
