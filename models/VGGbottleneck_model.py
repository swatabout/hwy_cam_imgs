...
for i in range(len(imglist)):
    if i < train_max: 
        shutil.move("/tensorflow/models/research/object_detection/camdata/OR1338_%s.png" % i,  "/tensorflow/models/research/object_detection/camdata/train/")
    elif train_max <= i < val_max : 
        shutil.move("/tensorflow/models/research/object_detection/camdata/OR1338_%s.png" % i, "/tensorflow/models/research/object_detection/camdata/validation")
    else:
        pass
...
val_files = glob.glob('/validation/validation/*')
